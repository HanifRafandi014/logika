  ...
  <div class="col-md-12">
    <div class="card">
      <div class="card-header d-flex justify-content-between align-items-center">
        <h4 class="card-title mb-0">Data Manajemen SKU</h4>
        <div class="d-flex ms-auto">
            <a href="{{ route('manajemen_sku.create') }}" class="btn btn-primary btn-sm me-2" title="Tambah SKU">
            ...
            <tbody>
                ...
                <tr>
                  ...
                  <td>
                    ...
                    <form action="{{ route('manajemen_sku.destroy', $sku->id) }}" method="POST" style="display:inline;">
                      @csrf
                      @method('DELETE')
