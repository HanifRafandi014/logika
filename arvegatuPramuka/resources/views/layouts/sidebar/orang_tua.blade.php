                  ...
                  <ul class="nav nav-collapse">
                      <li>
                          <a href="{{ route('pembayaran-iuran.index') }}">
                              <span class="sub-item">Pembayaran Paguyuban</span>
                          </a>
                      </li>
                      <li>
                      ...
                      <li>
                          <a href="{{ route('orang_tua.riwayat_transaksi_besar') }}">
                              <span class="sub-item">Riwayat Transaksi Akhir</span>
                          </a>
                      </li>
                      {{-- Link baru untuk seluruh orang tua --}}
                                  ...
                                  <ul class="nav nav-collapse">
                                      ...
                                      <li>
                                          <a href="{{ route('orang_tua.pengurus_kelas.riwayat_pembayaran_kelas') }}">
                                              <span class="sub-item">Verifikasi Pembayaran Kelas</span>
                                          </a>
                                      </li>
                                  </ul>
                              </div>
                          ...
                          <li class="nav-item">
                              ...
                              <div class="collapse" id="paguyubanBesarMenu">
                                  <ul class="nav nav-collapse">
                                      ...
                                      <li>
                                          <a href="{{ route('orang_tua.riwayat_transaksi_paguyuban') }}">
                                              <span class="sub-item">Riwayat Transaksi Paguyuban</span>
                                          </a>
                                      </li>
                                  </ul>
                              </div>
