        ...
        <div class="card-body">
            ...
            <div class="form-group category-display">
                ...
                <div style="flex-shrink: 0;">
                    <a href="{{ route('nilai_akademik.show_import_form', ['mata_pelajaran' => $selectedCategory]) }}" class="btn btn-success btn-import-category" title="Import Nilai Akademik">
            ...
            <form action="{{ route('nilai_akademik.store') }}" method="POST">
                ...
                <div class="mb-3 d-flex justify-content-start">
                    ...
                    <a href="{{ route('nilai_akademik.index') }}" class="btn btn-secondary" title="Batal">
