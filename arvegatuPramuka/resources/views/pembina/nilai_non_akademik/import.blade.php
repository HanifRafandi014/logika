...
<div class="col-md-6 offset-md-3"> {{-- Center the card --}}
    <div class="card">
        <div class="card-header d-flex justify-content-between align-items-center">
            <h4 class="card-title mb-0">Impor Nilai Non Akademik</h4>         
        </div>
        <div class="card-body">
            @if (session('success'))
            ...
            <div class="form-group category-display-import">
                <label for="displayKategoriImport">Kategori:</label>
                <input type="text" id="displayKategoriImport" class="form-control" value="{{ $selectedCategory }}" disabled>
            </div>

            <div class="import-section-card">
                <h5>Upload File Excel</h5>
                <form action="{{ route('nilai_non_akademik.import') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="mb-3">
                        ...
                        <input type="hidden" name="kategori_impor" value="{{ $selectedCategory }}">
                    </div>
