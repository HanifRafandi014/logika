<head>
    ...
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.15.4/css/all.min.css" integrity="sha512-1ycn6IcaQQ40JDrFNgychGUAUyVjQaqzLSYd0n1Nq3p4f+E20n2+03u+3h2cE8f9Xz+jF+7x+gY+2P+P+A+g==" crossorigin="anonymous" referrerpolicy="no-referrer" />
    <style>
        /* Basic table styling */
        .score-table {
            width: 100%;
...
<div class="col-md-12">
    <div class="card">
        ...
        <div class="card-body">
            {{-- Form for updating the record. Note the PUT method and passing $nilaiNonAkademik->id --}}
            <form action="{{ route('nilai_non_akademik.update', $nilaiNonAkademik->id) }}" method="POST">
                ...
                <div class="form-group category-display">
                    <label for="displayKategori">Kategori:</label>
                    <input type="text" id="displayKategori" class="form-control" value="{{ $selectedCategory }}" disabled>
                    {{-- No need for hidden category input here, as it's part of the route --}}
                </div>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <input type="number" class="form-control score-input" name="nilai" value="{{ old('nilai', $nilaiNonAkademik->nilai) }}" min="0" max="100">
